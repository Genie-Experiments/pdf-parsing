...
class HierarchyAccuracyCalculator:
    ...
    def _flatten_hierarchy(self, hierarchy: Dict, parent_path: str = "") -> List[Tuple[str, int]]:
        """
    ...
    def print_report(self):
        ...
        for level, metrics in report['level_accuracy'].items():
            ...
            print(f"  Count (GT/Extracted): {metrics['count_gt']}/{metrics['count_extracted']}")
...
if __name__ == "__main__":
    ...
    # Calculate accuracy
    calculator = HierarchyAccuracyCalculator(ground_truth_file='ground_truth_hierarchy.json', extracted_file='AP510e_Installation_Guide_fixed_hierarchy.json')
