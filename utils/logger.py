...
def log_processing_stats(total: int, processed: int, failed: int, 
    ...
    logger.info("Processing completed - Total: %d, Processed: %d, Failed: %d (%.1f%% success)", 
               total, processed, failed, success_rate)