    ...
    for page_num in sorted(headers_footers.keys()):
        ...
        if page_num == 1:
            ...
            for footer_text in page_footers:
                ...
                if new_page_content != page_content:
                    ...
                    changes_on_page += 1
                    logger.info(
                        f"Removed footer from page {page_num}: '{footer_text[:50]}...'"
                    )
        else:
            ...
            for header_text in page_headers:
                ...
                if new_page_content != page_content:
                    ...
                    changes_on_page += 1
                    logger.info(
                        f"Removed header from page {page_num}: '{header_text[:50]}...'"
                    )
        ...
        for watermark_text in page_watermarks:
            ...
            if new_page_content != page_content:
                ...
                changes_on_page += 1
                logger.info(
                    f"Removed watermark from page {page_num}: '{watermark_text[:50]}...')"
                )
            ...
            try:
                ...
                for page_num in sorted(headers_footers.keys()):
                    ...
                    if page_num == 1:
                        ...
                        # Remove footers
                        for footer_text in page_footers:
                            new_page_content = remove_text_from_content(
